...
and module-loader interaction, including requests rejected by the worker's
name or argument size checks. Catching those errors does not restore the budget.
Each module normalization and load counts as a separate request, while
