          ...
          <TypeTable
            type={{
              ...
              resolutions: {
                ...
                required: false,
                description:
                  'Values that resolve a non-empty subset of pending interruptions. Required when resuming a continuation; interruptions without a resolution remain pending.',
              },
              continuationContext: {
                type: 'unknown',
