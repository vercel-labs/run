...
[
  ...
  },
  {
    ...
    "type": "interface",
    "description": "A pending binding interruption.",
    "properties": [
      {
...
[
  {
    "name": "BindingFunction<ARGUMENTS extends unknown[] = unknown[], OUTPUT = unknown>",
    "type": "(...args: ARGUMENTS) => OUTPUT | Promise<OUTPUT>",
    "description": "A host function made available to sandboxed JavaScript."
  },
  {
    "name": "BindingGroup",
    "type": "Record<string, BindingFunction<never[], unknown>>",
    "description": "A named collection of host functions."
  },
  {
    "name": "Bindings",
    "type": "Record<string, BindingGroup>",
    "description": "Host function groups installed as guest globals."
  },
  {
    "name": "BindingContext",
    "type": "interface",
    "description": "Context supplied to each host binding invocation.",
    "properties": [
      {
        "type": "BindingContext",
        "parameters": [
          ...
          },
          {
            "name": "requestId",
            "type": "string",
            "description": "The binding request identifier."
          },
          {
            "name": "requestIndex",
            "type": "number",
            "description": "The one-based binding request order."
          },
          {
            "name": "bindingName",
            "type": "string",
          ...
          },
          {
            ...
            "isOptional": true,
            "description": "Resume data for a replayed interrupted binding."
          }
        ]
      }
    ]
...
[
  ...
  },
  {
    ...
    "description": "A recorded binding outcome.",
    "properties": [
      {
        ...
        "parameters": [
          ...
          },
          {
            "name": "inputJson",
            "type": "string",
            "description": "The serialized binding input."
          },
          {
            "name": "status",
            "type": "'fulfilled'",
